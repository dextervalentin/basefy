...
$comTab = $comTab ?? 'chat';
$tabs = [
    'chat'      => ['label' => 'Chat',      'href' => BASE_PATH . '/chat',              'icon' => 'message-circle'],
    'denuncias' => ['label' => 'Denúncias', 'href' => BASE_PATH . '/denuncias',         'icon' => 'flag'],
    'tickets'   => ['label' => 'Tickets',   'href' => BASE_PATH . '/tickets_dashboard', 'icon' => 'ticket'],
];
?>
