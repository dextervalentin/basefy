<?php
// filepath: views/partials/financeiro_tabs_vendor.php
$finTab = $finTab ?? 'wallet';
$tabs = [
    'wallet'    => ['label' => 'Carteira',  'href' => BASE_PATH . '/vendedor/wallet',    'icon' => 'wallet-cards'],
    'depositos' => ['label' => 'Depósitos', 'href' => BASE_PATH . '/vendedor/depositos', 'icon' => 'banknote'],
    'saques'    => ['label' => 'Saques',    'href' => BASE_PATH . '/vendedor/saques',    'icon' => 'arrow-down-up'],
];
?>
