...
$comTab = $comTab ?? 'chat';
$tabs = [
    'chat'      => ['label' => 'Chat',      'href' => BASE_PATH . '/vendedor/chat',      'icon' => 'message-circle'],
    'denuncias' => ['label' => 'Denúncias', 'href' => BASE_PATH . '/vendedor/denuncias', 'icon' => 'flag'],
    'tickets'   => ['label' => 'Tickets',   'href' => BASE_PATH . '/vendedor/tickets',   'icon' => 'ticket'],
];
?>
