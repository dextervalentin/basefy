...
<div class="chat-page">
    ...
    <div class="chat-main">
        ...
        <div class="chat-main-messages" id="vendorChatMsgs">
            ...
            <?php endif; ?>
            <?php $attachment = chatParseAttachmentMessage((string)$m['message']); ?>
        ...
        <div class="chat-main-compose">
            <div id="vendorChatAttachmentBar" class="chat-attachment-bar">
                <span class="attachment-name" id="vendorChatAttachmentName"></span>
                <button type="button" class="attachment-clear" id="vendorChatAttachmentClear">Remover</button>
            </div>
        <div class="chat-main-input">
            <input type="file" id="vendorChatFile" accept="image/*" hidden>
            <label class="attach-btn" id="vendorChatAttachBtn" for="vendorChatFile" title="Enviar print">
        ...
        (function(){
            ...
            const fileInput = document.getElementById('vendorChatFile');
            const attachBtn = document.getElementById('vendorChatAttachBtn');
            const attachBar = document.getElementById('vendorChatAttachmentBar');
            const attachName = document.getElementById('vendorChatAttachmentName');
            const attachClear = document.getElementById('vendorChatAttachmentClear');
            ...
            function appendMsg(m) {
                ...
                const attachment = parseAttachmentMessage(m.message || '');
                if (attachment) {
